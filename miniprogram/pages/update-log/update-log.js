    ...
    updateList: [
      {
        ...
        changes: [
          ...
          { emoji: "✨", text: "新增幸运转盘、我的奖品和现场核销" },
          { emoji: "✨", text: "新增活动、抽奖和管理消息提醒" },
          { emoji: "⚡", text: "管理员和官方账号权限分开，后台菜单更清晰" },
          { emoji: "✨", text: "活动回顾可以直接关联已有官方活动" },
          { emoji: "✨", text: "路线详情支持加粗、字号和文字颜色" },
          { emoji: "✨", text: "活动支持暂存、撤回和重新编辑" },
          { emoji: "🔧", text: "修复登录、报名、保险显示和部分页面错位问题" },
          { emoji: "🔧", text: "修复报名截止和活动结束状态显示" },
          { emoji: "⚡", text: "抽奖口令支持查看和修改，奖品兑换码长期有效" },
          { emoji: "⚡", text: "优化路线、回顾、天气和抽奖体验" }
        ]
      },
      {
        version: "1.2.0",
